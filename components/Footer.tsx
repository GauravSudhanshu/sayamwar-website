...
const socialLinks = [
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/sayamwar_hall_homestay/',
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <footer className={`bg-[var(--black-2)] text-white border-t border-[var(--gold)]/15 ${className}`}>
        ...
        <div>
          ...
          <ul className="space-y-3">
            {[
              ...
              { href: '/engagement-hall-patna', label: 'Engagement Hall' },
              { href: '/reception-hall-patna', label: 'Reception Hall' },
              { href: '/corporate-event-hall-patna', label: 'Corporate Events' },
      ...
      <div className="border-t border-white/5 py-5 px-6">
        <div className="max-w-7xl mx-auto">
          <p className="text-white/20 text-[10px] uppercase tracking-[0.25em] mb-3 text-center">Find Us Online</p>
